...
public class CookController {
	...
	@RequestMapping(value = "/getAllCook", method = RequestMethod.GET)
	public String getAllCook(Model model) {
		List<Cook> loc = cookservice.getAllCook();
...
//	@RequestMapping(value="/getAllProductByCookID",method = RequestMethod.GET)
