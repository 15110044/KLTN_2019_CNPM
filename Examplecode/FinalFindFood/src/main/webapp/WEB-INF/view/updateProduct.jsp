	...
	<div class="jumbotron">
		...
		<div class="container"
			...
			<form class="form-horizontal" method="POST" modelAttribute="product"
				action="/FindFood/addProduct" enctype="multipart/form-data">
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<input id="product_name" path="nameProduct" size="30"
								...
								class="form-control input-md" required="" type="text" value="${product.nameProduct}">
						...
						<div class="col-md-4">
							<select id="product_categorie" name="proCategory"
								...
								<c:forEach items="${categories }" var="cate">
									<option value="${cate.categoryID }" ${cate.categoryID == product.category.categoryID ? 'selected':'' }>${cate.nameCategory }</option>
								</c:forEach>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<textarea class="form-control" id="product_description"
								path="description" size="30" maxlength="30" name="proDesc" placeholder="${product.description }"></textarea>
						</div>
					</div>
					<!-- File Button -->
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-4">
							<button id="updateProduct" name="updateProduct" class="btn btn-primary">Update</button>
						</div>
					</div>
				</fieldset>
			</form>
